...
!(function() {
	...
	var R = T[g],
		...
		F = !1
	m &&
		((F = (f.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
			f.readyState
		)) ||
	...
	function nt(t) {
		...
		u && (b.attributes[v] = ''),
			f &&
				b.children.push({
					tag: 'title',
					attributes: { id: b.attributes['aria-labelledby'] || 'title-' + X() },
					children: [f]
				})
		var y = O({}, b, {
				prefix: r,
	...
	function it(t) {
		...
		G(r) &&
			...
			(x +=
				...
				') '),
			(x += 'rotate(' + u.rotate + 'deg) '))),
			(k['-webkit-transform'] = k.transform))
		var C = K(k)
		C.length > 0 && (l.style = C)
		var z = []
		return (
			z.push({ tag: 'span', attributes: l, children: [e] }),
			a &&
				z.push({
					tag: 'span',
	...
	var rt = function() {},
		at =
			S.measurePerformance && c && c.mark && c.measure
				? c
				: { mark: rt, measure: rt },
		ot = 'FA "5.0.6"',
		st = function(t) {
		...
		0 === t.length
			...
			: (s.requestAnimationFrame ||
					...
					var e =
							!0 === S.autoReplaceSvg
								? Ct.replace
								: Ct[S.autoReplaceSvg] || Ct.replace,
						i = ft.begin('mutate')
					t.map(e), i(), n()
			  })
	}
	...
	var Ot = function(t) {
		...
		Lt = function(t) {
			return Mt(t.getAttribute('data-fa-transform'))
		},
		Et = function(t) {
	...
	var Tt = { fill: 'currentColor' },
		...
		It = {
			...
			children: [
				...
				{
					tag: 'circle',
					attributes: O({}, Tt, { cx: '256', cy: '364', r: '28' }),
					children: [
						{
							tag: 'animate',
							attributes: O({}, Rt, {
						...
						{
							tag: 'animate',
							attributes: O({}, Ft, { values: '1;0;1;1;0;1;' })
						}
					]
				},
				{
					...
					children: [
						{
							tag: 'animate',
							attributes: O({}, Ft, { values: '1;0;0;0;0;1;' })
						}
					]
				},
				{
					...
					children: [
						{
							tag: 'animate',
							attributes: O({}, Ft, { values: '0;0;1;1;0;0;' })
						}
					]
				}
			]
		...
		_t = R.styles,
		Bt = 'fa-layers-text',
		Dt = /Font Awesome 5 (Solid|Regular|Light|Brands)/,
		Wt = { Solid: 'fas', Regular: 'far', Light: 'fal', Brands: 'fab' }
	function Xt(t, e) {
		var n = { found: !1, width: 512, height: 512, icon: It }
		if (t && e && _t[e] && _t[e][t]) {
			var i = _t[e][t]
			n = {
				found: !0,
			...
			throw new Pt('Icon is missing for prefix ' + e + ' with icon name ' + t)
		return n
	}
	function Yt(t) {
		var e,
		...
		return ~x.extra.classes.indexOf(Bt)
			? (function(t, e) {
					var n = e.title,
						i = e.transform,
						r = e.extra,
			...
			: ((u = t),
			  ...
			  [
					u,
					nt({
						icons: { main: Xt(g, p), mask: Xt(y.iconName, y.prefix) },
						prefix: p,
						iconName: g,
						transform: v,
						symbol: b,
					...
					Y(t.querySelectorAll('*')).forEach(function(t) {
						;[':before', ':after'].forEach(function(e) {
							var n = s.getComputedStyle(t, e),
								i = n.getPropertyValue('font-family').match(Dt),
							...
							if (
								(r &&
									(r.nextSibling &&
										r.nextSibling.textContent.indexOf(b) > -1 &&
										Ut(r.nextSibling),
									Ut(r),
									(r = null)),
								i && !r)
	...
	function te(t) {
		var e = t.prefix,
			n = void 0 === e ? 'fa' : e,
			i = t.iconName
		if (i) return yt(ne.definitions, n, i) || yt(R.styles, n, i)
	}
	var ee,
		ne = new ((function() {
			function t() {
		...
		ie = ((ee = function(t) {
			...
			if (t) {
				var p = t.prefix,
					v = t.iconName,
					b = t.icon
				return $t(O({ type: 'icon' }, t), function() {
					return (
						Zt(),
						S.autoA11y &&
							(l
		...
		re = {
			...
			dom: {
				i2svg: function() {
					...
					if (m) {
						...
						S.searchPseudoElements && Vt(n), qt(n, r)
					}
				},
				css: Gt,
				insertCss: function() {
			...
			text: function(t) {
				var e =
					...
					c = e.styles,
					u = void 0 === c ? {} : c
				return $t({ type: 'text', content: t }, function() {
					return (
						Zt(),
						it({
							content: t,
		...
		ae = function() {
			m && S.autoReplaceSvg && re.dom.i2svg({ node: f })
		}
	Object.defineProperty(re, 'config', {
		get: function() {
			return S
		},
		set: function(t) {
		...
		(function(t) {
			...
			u &&
				(s.FontAwesome || (s.FontAwesome = re),
				I(function() {
					Object.keys(R.styles).length > 0 && ae(),
						S.observeMutations &&
							...
							(function(t) {
								if (l) {
												...
												Y(t).forEach(function(t) {
													if (
														('childList' === t.type &&
															...
															!kt(t.addedNodes[0]) &&
															(S.searchPseudoElements && i(t.target),
															e(t.target)),
														'attributes' === t.type &&
															t.target.parentNode &&
									...
									m &&
										r.observe(f.getElementsByTagName('body')[0], {
											childList: !0,
											attributes: !0,
											characterData: !0,
											subtree: !0
				...
				(R.hooks = O({}, R.hooks, {
					addPack: function(t, e) {
						;(R.styles[t] = O({}, R.styles[t] || {}, e)), ht(), ae()
					},
					addShims: function(t) {
						var e
						;(e = R.shims).push.apply(e, M(t)), ht(), ae()
					}
				}))
		})
})()
